...
import FavoritesOffersList from '../../components/favorites/favorites-offers-list/favorites-offers-list';
import { Link } from 'react-router-dom';
import NoFavoritesList from '../../components/favorites/no-favorites-list/no-favorites-list';
