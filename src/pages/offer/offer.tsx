...
import { SCALE_RATING } from '../../const/const';
import { useParams } from 'react-router-dom';
import NotFoundPage from '../not-found-page/not-found-page';
import ReviewsSection from '../../components/offer/reviews/reviews-section/reviews-section';
import NearOffersList from '../../components/offer/near-offers-list/near-offers-list';
...
import Bookmark from '../../components/favorites/bookmark/bookmark';
import { TypeBookmark } from '../../const/const';
...
export default function Offer(): JSX.Element {
  ...
  const { price, title, isPremium, images, rating, type, city, bedrooms, maxAdults, goods, description, isFavorite, host } = currentDetailedOffer;
