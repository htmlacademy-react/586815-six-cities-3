...
import { REVIEW_MIN_SIZE, REVIEW_MAX_SIZE } from '../../../../const/const';
    ...
    >
      ...
      <div className="reviews__button-wrapper">
        ...
        <button
          ...
          type="submit"
          disabled={review.comment.length < REVIEW_MIN_SIZE || review.comment.length > REVIEW_MAX_SIZE || review.rating === 0 || isSending}
        >Submit
        </button>
      </div>
    </form>
